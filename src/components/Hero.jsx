...
function Hero() {
  return (
    <div className="flex flex-col items-center justify-center pt-45 md:pt-40 ">
      <div
        className="h-[140px] w-[140px] bg-cover bg-center  rounded-full "
        style={{ backgroundImage: `url(${Profile})` }}
      ></div>

      <p className="text-[4rem] text-center md:text-[5.5rem] text-white/64 font-bold">
        Eleanor Opollo
      </p>
      <p className="text-[2rem] md:text-[4rem] font-bold text-white/36">
        Frontend Engineer
      </p>
      <div className="w-5/6 md:w-3/4 lg:w-1/3 flex flex-col gap-1 mt-3">
      ...
      <div className="w-full px-4 md:px-0 md:w-5/6 lg:w-3/6 flex items-center justify-between gap-3 mt-10">
